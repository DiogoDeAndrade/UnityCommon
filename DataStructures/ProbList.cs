...
namespace UC
{
    ...
    public class ReferenceProbList<T> : IEnumerable<(T element, float weight)>
    {
        ...
        // Constructor with optional Random generator and option for with/without replacement
        public ReferenceProbList(bool withReplacement = true, bool resetWhenEmpty = true, System.Random randomGenerator = null)
        {
            this.withReplacement = withReplacement;
            this.resetWhenEmpty = resetWhenEmpty;
            this.systemRandom = randomGenerator; // Default to System.Random if no Unity engine available
        ...
        // Copy constructor that takes a collection and initializes with default counts
        public ReferenceProbList(ProbList<T> items, bool withReplacement = true, bool resetWhenEmpty = true, System.Random randomGenerator = null)
        {
            this.withReplacement = withReplacement;
            this.resetWhenEmpty = resetWhenEmpty;
            this.systemRandom = randomGenerator ?? new System.Random();
        ...
        public ReferenceProbList(T initialItem)
        {
            this.withReplacement = true;
            this.resetWhenEmpty = true;
    ...
    public sealed class ProbListReplacementOptionAttribute : Attribute
    {
        public bool Enabled { get; }

        public ProbListReplacementOptionAttribute(bool enabled)
        {
            Enabled = enabled;
        }
    }
